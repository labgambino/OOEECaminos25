...
var map = new ol.Map({
    ...
    view: new ol.View({
         maxZoom: 28, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:25830',
            //extent: [-4.167331, 36.932806, 621273.000000, 4288700.000000],
            units: 'm'})
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([378230.943750, 4062947.562500, 433319.493750, 4094045.937500], map.getSize());
...
var searchLayer = new SearchLayer({
    layer: lyr_MunicipiosSeleccion_73,
    colName: 'nombre',
    zoom: 10,
    collapsed: true,
    map: map
